...
$router->get("{$urlBase}pdfs/contratosFuturos/{contrato}", "PDF\ContratosFuturosController@index");
$router->get("{$urlBase}pdfs/contratosAtuais/{contrato}", "PDF\ContratosAtuaisController@index");
